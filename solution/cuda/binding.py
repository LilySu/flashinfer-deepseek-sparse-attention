"""DSA TopK Indexer — Pure PyTorch reference as binding.py entry point.

Skips the CUDA kernel entirely. If this passes 128/128, it proves the
framework correctly calls binding.py::kernel. Then we can wire in the
CUDA kernel incrementally.
"""
